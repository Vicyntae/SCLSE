...
SKSE64 SE 2.0.7 latest version: http://skse.silverlock.org/
Skyrim SE 1.5.39
...
Currently, forms stored via StorageUtil and JsonUtil that come from CreatorsClub .esl files 
will fail to properly store and return back to their original form.
...
eventHandler, Expired, aers - SKSE64 conversion & update assistance
